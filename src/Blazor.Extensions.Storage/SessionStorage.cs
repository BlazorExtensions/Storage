...
namespace Blazor.Extensions.Storage
{
    public class SessionStorage : IStorage
    {
        ...
        public ValueTask<int> GetLengthAsync() => this.runtime.InvokeAsync<int>(MethodNames.LENGTH_METHOD, StorageTypeNames.SESSION_STORAGE);

        public ValueTask ClearAsync() => this.runtime.InvokeVoidAsync(MethodNames.CLEAR_METHOD, StorageTypeNames.SESSION_STORAGE);
        ...
        public ValueTask<string> GetKeyAsync(int index) => this.runtime.InvokeAsync<string>(MethodNames.KEY_METHOD, StorageTypeNames.SESSION_STORAGE, index);
